...
const notifications = [
  {
    id: 1, type: 'task', icon: <AssignmentIcon />, color: '#a78bfa', bg: 'rgba(167,139,250,0.15)',
    title: 'New task assigned to you',
    message: 'Fix login bug has been assigned to you by John',
    time: '2 minutes ago', read: false
  },
  {
    id: 2, type: 'complete', icon: <CheckCircleIcon />, color: '#34d399', bg: 'rgba(52,211,153,0.15)',
    title: 'Task completed',
    message: 'Setup database has been marked as completed',
    time: '1 hour ago', read: false
  },
  {
    id: 3, type: 'comment', icon: <CommentIcon />, color: '#60a5fa', bg: 'rgba(96,165,250,0.15)',
    title: 'New comment on your task',
    message: 'Sara commented on Design dashboard task',
    time: '3 hours ago', read: true
  },
  {
    id: 4, type: 'member', icon: <PersonIcon />, color: '#fbbf24', bg: 'rgba(251,191,36,0.15)',
    title: 'New team member joined',
    message: 'Mike has joined the project as Project Manager',
    time: '1 day ago', read: true
  },
  {
    id: 5, type: 'task', icon: <AssignmentIcon />, color: '#a78bfa', bg: 'rgba(167,139,250,0.15)',
          ...
          {notifications.map((notif, index) => (
            <Box key={notif.id} sx={{
              ...
              <Box sx={{
                ...
                justifyContent: 'center', color: notif.color,
                flexShrink: 0
              }}>
                {notif.icon}
              </Box>
              ...
              <Box sx={{ flex: 1 }}>
                ...
                <Typography variant="body2" sx={{ color: 'rgba(255,255,255,0.5)', mb: 0.5, fontSize: 13 }}>
                  {notif.message}
                </Typography>
